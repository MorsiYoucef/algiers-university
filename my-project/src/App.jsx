...
function App() {
  return (
    <main className="">
      <Nav />
      <div className="max-w-[1486px] mx-auto border-l border-r">
      ...
      <section className=" bg-my-blue grid gap-10 ">
        <NewsLetter />
        <div className=" w-[900px] h-0.5 bg-white relative left-[600px]"></div>
        <Footer />
